...
var CreateUsuarioController = /** @class */ (function () {
    function CreateUsuarioController(createUsuarioUseCase) {
        this.createUsuarioUseCase = createUsuarioUseCase;
    }
    CreateUsuarioController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, email, senha;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, request.body];
                    case 1:
                        _a = _b.sent(), name = _a.name, email = _a.email, senha = _a.senha;
                        return [4 /*yield*/, this.createUsuarioUseCase.execute({ name: name, email: email, senha: senha })];
                    case 2:
                        _b.sent();
